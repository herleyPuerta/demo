...
MOTOR_DB = 'sqlite' #motor principal del proyecto
...
SECRET_KEY = 'ionul%&amp;iux+^3=os5oz*!fl_!fw3%xjxcw)-z*$trk8(p7gb8&amp;'
...
# identificar o definir el perfil de los usuarios, extension del perfil de usuario
